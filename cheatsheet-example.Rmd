...
<!--
**Source: Dave Richeson, Dickinson College, \href{http://divisbyzero.com/}{http://divisbyzero.com/}**
-->

## Some Quantim Mechanics Physics Equations.

Source: https://www.overleaf.com/articles/griffith-quantum-mechanics-time-dependent-perturbation-theory-cheatsheet-ucb-137b-final/jwynrzctvqgp
...
Or, the Rmarkdown way (with `$$`), which enables inline previews (in RStudio).
